...
return (
  ...
  pieProgress: `import { motion } from 'motion/react';
import { useState, useEffect } from 'react';
...
export function PieProgress() {
    ...
    <div className="relative w-24 h-24">
      <svg className="w-24 h-24 -rotate-90" viewBox="0 0 100 100">
        <circle
          ...
          fill="none" stroke="rgb(255 255 255 / 0.1)" strokeWidth="8"
        />
        <motion.circle
          cx="50" cy="50" r={radius}
          fill="none" stroke="rgb(255 255 255)" strokeWidth="8"
  ...
  animatedPieProgress: `import { motion } from 'motion/react';
import { useState, useEffect } from 'react';
...
export function AnimatedPieProgress() {
    ...
    <div className="relative w-20 h-20">
      <svg className="w-20 h-20 -rotate-90" viewBox="0 0 88 88">
        <circle
          ...
          fill="none" stroke="rgb(255 255 255 / 0.08)" strokeWidth="6"
        />
        <motion.circle
          cx="44" cy="44" r={radius}
          fill="none" stroke="rgb(255 255 255)" strokeWidth="6"
          strokeLinecap="round" strokeDasharray={circumference}
          animate={{ 
            strokeDashoffset,
            stroke: [
        ...
        />
        <motion.circle
          cx="44" cy="44" r="3" fill="rgb(255 255 255)"
  ...
  segmentedPieProgress: `import { motion } from 'motion/react';
import { useState, useEffect } from 'react';
...
export function SegmentedPieProgress() {
        ...
        {Array.from({ length: segments }, (_, i) => {
          ...
          return (
            <motion.circle
              key={i}
              cx="40" cy="40" r="32"
              fill="none" stroke={isActive ? "rgb(255 255 255)" : "rgb(255 255 255 / 0.1)"}
  ...
  glowingPieProgress: `import { motion } from 'motion/react';
import { useState, useEffect } from 'react';
    ...
    <div className="relative w-20 h-20">
      <svg className="w-20 h-20 -rotate-90" viewBox="0 0 84 84">
        <circle
          ...
          fill="none" stroke="rgb(255 255 255 / 0.05)" strokeWidth="4"
        />
        <motion.circle
          cx="42" cy="42" r={radius}
          fill="none" stroke="rgb(255 255 255)" strokeWidth="4"
          strokeLinecap="round" strokeDasharray={circumference}
          animate={{ 
            strokeDashoffset,
            filter: [
